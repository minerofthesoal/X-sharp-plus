...
static inline ShaderVaryings varying_interpolate(
    const ShaderVaryings *v0, const ShaderVaryings *v1, const ShaderVaryings *v2,
    float w0, float w1, float w2, int count)
{
    ShaderVaryings r;
...
typedef VertexOutput (*VertexShaderFn)(const VertexInput *in,
                                       const ShaderUniform *uniforms, int uniform_count);

typedef Vec4 (*FragmentShaderFn)(const FragmentInput *in,
                                  const ShaderUniform *uniforms, int uniform_count);
