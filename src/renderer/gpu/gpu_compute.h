...
typedef enum { GPU_BACKEND_NONE, GPU_BACKEND_CPU, GPU_BACKEND_OPENCL } GpuBackend;

typedef enum { GPU_MEM_READ_ONLY, GPU_MEM_WRITE_ONLY, GPU_MEM_READ_WRITE } GpuMemFlags;
