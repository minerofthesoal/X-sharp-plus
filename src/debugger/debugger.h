...
void        xs_debugger_show_source_context(XsDebugger *dbg, int center_line,
                                            int context_lines);

/* ===== Events ===== */
void        xs_debugger_set_event_callback(XsDebugger *dbg,
                                            XsDbgEventCallback cb, void *data);
...
void            xs_debugger_get_location(XsDebugger *dbg, char *file,
                                          int *line, int *column);
