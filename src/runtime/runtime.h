...
/* ===== Value Constructors ===== */
static inline XsValue xs_blade(int64_t v) {
    XsValue val;
    val.type = VAL_BLADE;
    val.blade = v;
    return val;
}
static inline XsValue xs_spark(double v) {
    XsValue val;
    val.type = VAL_SPARK;
    val.spark = v;
    return val;
}
static inline XsValue xs_fate(bool v) {
    XsValue val;
    val.type = VAL_FATE;
    val.fate = v;
    return val;
}
static inline XsValue xs_abyss(void) {
    XsValue val;
    val.type = VAL_ABYSS;
    val.blade = 0;
    return val;
...
static inline int64_t xs_as_blade(XsValue v) {
    return v.blade;
}
static inline double xs_as_spark(XsValue v) {
    return v.type == VAL_SPARK ? v.spark : (double)v.blade;
}
static inline char* xs_as_scroll(XsValue v) {
    return v.scroll;
}
static inline bool xs_as_fate(XsValue v) {
    return v.fate;
}
